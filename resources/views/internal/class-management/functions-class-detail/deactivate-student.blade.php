<form method="POST" action="/class-management/deactivate/student/{{ $data->id }}">
    @csrf 
    {{ method_field('PATCH') }}
    ...
    <div class="modal" id="deactivate-school-internal" tabindex="-1" role="dialog" aria-labelledby="naw" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="naw">Non-aktifkan Siswa</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <div class="modal-body">
            <Span style="font-size:20px;">Anda yakin ingin Mentidak-aktifkan siswa</Span>
