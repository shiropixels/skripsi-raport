...
<form method="POST" action="/auth/internal/update/{{ $data->id }}">
    @csrf
    {{ method_field('PUT') }}

<div class="modal fade" id="school-internal-detail-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModal3Label" aria-hidden="true">
...
<script type="text/javascript">
    $('#school-internal-detail-modal').modal('show');
