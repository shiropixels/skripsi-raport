<form method="POST" action="/student/activate/{{$data->id}}">
    @csrf
    {{ method_field('PATCH') }}
...
<div class="modal fade" id="student-deactive-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModal3Label" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <h5 class="modal-title" id="exampleModal3Label">Aktifkan Siswa - {{ $data->name }}</h5>
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Aktifkan Siswa</button>
